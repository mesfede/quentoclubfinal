...
const FACILITIES: FacilityItem[] = [
  {
    id: 'canchas',
    title: '6 Canchas Premium Techadas',
    ...
    <section id="el-club" className="py-20 sm:py-28 bg-neutral-950 text-white overflow-hidden scroll-mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-10 sm:mb-16">
          ...
          <div className="w-16 h-1 bg-[#d21a23] mt-3 rounded-full" />
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            >
              ...
              <div className="absolute top-4 right-4 px-3 py-1.5 rounded-full bg-neutral-950/70 text-white text-xs font-bold flex items-center space-x-1.5 backdrop-blur-sm group-hover:bg-[#d21a23] transition-colors">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/90 backdrop-blur-xl">
            ...
            >
              ...
              <button
                ...
                className="absolute top-4 right-4 z-30 p-2.5 rounded-full bg-black/70 text-white/90 hover:text-white hover:bg-[#d21a23] transition-all cursor-pointer shadow-lg"
              ...
              <div className="relative h-72 sm:h-96 md:h-[480px] w-full bg-black flex items-center justify-center overflow-hidden">
                ...
                {selectedFacility.gallery.length > 1 && (
                  <button
                    ...
                    className="absolute left-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-black/60 hover:bg-[#d21a23] text-white transition-all backdrop-blur-md cursor-pointer"
                ...
                {selectedFacility.gallery.length > 1 && (
                  <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-black/60 hover:bg-[#d21a23] text-white transition-all backdrop-blur-md cursor-pointer"
                ...
                <div className="absolute bottom-4 left-6 right-6 z-10 flex flex-col sm:flex-row sm:items-end justify-between gap-2">
                  <div>
                    <span className="inline-block px-2.5 py-1 rounded-md bg-[#d21a23] text-white text-[10px] sm:text-xs font-black uppercase tracking-wider mb-1">
              ...
              <div className="p-4 sm:p-5 bg-neutral-900 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-t border-neutral-800">
                    ...
                    <button
                      ...
                      className={`relative w-16 h-12 sm:w-20 sm:h-14 rounded-xl overflow-hidden border-2 transition-all shrink-0 cursor-pointer ${
                        activeImageIndex === idx
                          ? 'border-[#d21a23] scale-105 shadow-md shadow-red-900/40 ring-1 ring-red-400'
                ...
                <div className="flex items-center space-x-3 shrink-0">
                  <button
                    ...
                    className="px-5 py-3 rounded-xl bg-[#d21a23] hover:bg-red-700 text-white font-extrabold text-xs uppercase tracking-wider transition-all shadow-md flex items-center space-x-2 cursor-pointer"
                  >
