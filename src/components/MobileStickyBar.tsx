    ...
    <div className="fixed bottom-0 left-0 right-0 z-40 md:hidden pointer-events-auto">
      ...
      <div className="mx-auto max-w-lg px-3 pb-3 pt-1">
        ...
        >
          ...
          >
            <Home className={`w-5 h-5 transition-transform ${activeTab === 'inicio' ? 'scale-110 text-[#d21a23]' : ''}`} />
            <span className="text-[10px] font-black uppercase tracking-tight mt-1">Inicio</span>
            {activeTab === 'inicio' && (
              <motion.div layoutId="appTabDot" className="w-1 h-1 rounded-full bg-[#d21a23] mt-0.5" />
            )}
          </button>
          ...
          >
            <Shield className={`w-5 h-5 transition-transform ${activeTab === 'el-club' ? 'scale-110 text-[#d21a23]' : ''}`} />
          ...
          >
            <div className="w-13 h-13 rounded-full bg-[#d21a23] hover:bg-red-700 text-white flex items-center justify-center shadow-lg shadow-red-950/80 border-3 border-neutral-950 transition-all transform group-active:scale-95 group-hover:scale-105 ring-2 ring-red-500/40">
          ...
          >
            <Trophy className={`w-5 h-5 transition-transform ${activeTab === 'torneos' ? 'scale-110 text-[#d21a23]' : ''}`} />
          ...
          >
            <MapPin className={`w-5 h-5 transition-transform ${activeTab === 'contacto' ? 'scale-110 text-[#d21a23]' : ''}`} />
